<!-- test-prog 
[d6-P<2:1> should be <1:1>]接_歪 count only 1? d6 is being double-counted now in the def-cat, onl from: f6-Q; on which vect? 
	✅W:d6 in this pos onlt the Q has zhi-E indee, Array ( [2] => Array ( [0] => d6 [1] => s ) ) app-onl: W-arr in zhi 
	poss: a chu-fork again of the Q, app'n, the diag-als anti-interf,test d6 also in $NE of Q: need another elseif-elucid elim any zhis -->
<!-- Notes: 
